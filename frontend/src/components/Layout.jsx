...
// import { Bell, Menu, X, Sun, Moon, User, LogOut } from 'lucide-react';
...
//             </div>
//             <h1 className="text-xl font-bold text-gray-900 dark:text-white">LIMS</h1>
//           </div>
//           <button
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden lg:ml-0">
        {/* Header */}
        <header className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 h-16 shrink-0">
