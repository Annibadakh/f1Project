...
const ComponentForm = ({ component, onSubmit, onCancel }) => {
  ...
  useEffect(() => {
    if (component) {
      setFormData({
        ...
        manufacturer_supplier: component.manufacturer_supplier || '',
        part_number: component.part_number || '',
        description: component.description || '',
        quantity: component.quantity || 0,
        location_bin: component.location_bin || '',
        unit_price: component.unit_price || 0,
        datasheet_link: component.datasheet_link || '',
        category: component.category || 'Others',
        critical_low_threshold: component.critical_low_threshold || 10,
